...
import com.putorn.powerdoc.util.RedisUtil;
...
////        return redisUtil.generateTableId(entity.getClass().getSimpleName());
//    }
    ...
    public int save(T t) {
//        t.setId(getId());
        PowerSysUser currentUser = UserSessionContext.getuser();
        if(currentUser != null && currentUser.getUsername() != null) {
            t.setAddUserid(currentUser.getId().intValue());
            t.setAddUsername(currentUser.getUsername());
            t.setAddtime(Timestamp.valueOf(DateUtil.getDateTime()));
        }
    ...
    public int update(T t) {
        PowerSysUser currentUser = UserSessionContext.getuser();
        if(currentUser != null && currentUser.getUsername() != null) {
            t.setEdittime(Timestamp.valueOf(DateUtil.getDateTime()));
            t.setEditUserid(currentUser.getId().intValue());
            t.setEditUsername(currentUser.getUsername());
        }

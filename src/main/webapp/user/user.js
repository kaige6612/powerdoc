...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tableList').bootstrapTable({
            url: '/powerSysUser/queryUserList',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
    ...
    oInit.Init = function () {
        ...
        $("#btn_edit").click(function () {
            ...
            layer.open({
                ...
                success:function(dom){
                    ...
                    // $iframeDom.find("#nickname").val(arrselections[0].nickname);
                    $(dom[0]).find("iframe")[0].contentWindow.setFormVal(arrselections[0]);
        ...
        $("#btn_delete").click(function () {
            ...
            layer.confirm('确认要删除选择的数据吗？', {
                ...
                $.ajax({
                    method: "get",
                    url: "/powerSysUser/deleteUserById",

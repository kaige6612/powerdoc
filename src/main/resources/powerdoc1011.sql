...
/*Table structure for table `power_doc_resistance_detail` */

DROP TABLE IF EXISTS `power_doc_resistance_detail`;

CREATE TABLE `power_doc_resistance_detail` (
  `detail_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '变压器直流电阻报告主键',
  `subreport_id` bigint(11) DEFAULT NULL COMMENT '所属报告id',
  `row_num` varchar(4) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT '' COMMENT '行号',
  `high_AO` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT '' COMMENT '高压侧直阻（m）_AO',
  `high_BO` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT '' COMMENT '高压侧直阻（m）_BO',
  `high_CO` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT '' COMMENT '高压侧直阻（m）_CO',
  `high_error` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT '' COMMENT '高压侧直阻（m）_相间最大误差(%)',
  `middle_AmOm` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT '' COMMENT '中压侧直阻（m）_AmOm',
  `middle_BmOm` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT '' COMMENT '中压侧直阻（m）_BmOm',
  `middle_CmOm` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT '' COMMENT '中压侧直阻（m）_CmOm',
  `middle_error` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT '' COMMENT '中压侧直阻（m）_error',
  `add_userid` int(11) DEFAULT NULL COMMENT '添加人id',
  `add_username` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '添加人姓名',
  `addtime` datetime DEFAULT NULL COMMENT '添加时间',
  `edit_userid` int(11) DEFAULT NULL COMMENT '修改人id',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='变压器直流电阻试验报告详细内容';

/*Data for the table `power_doc_resistance_detail` */

LOCK TABLES `power_doc_resistance_detail` WRITE;
...
CREATE TABLE `power_sub_report` (
  ...
  `device_model_id` bigint(20) DEFAULT NULL COMMENT '设备模板表',
...
insert  into `power_sub_report`(`id`,`device_model_id`,`report_id`,`device_id`,`device_name`,`device_type`,`air_temperature`,`humidity`,`run_humidity`,`oil_temperature`,`connect_group`,`model_no`,`producer`,`capacity`,`run_no`,`run_date`,`production_date`,`production_no`,`instrument_ids`,`instrument_names`,`test_date`,`status`,`conclusion`,`remark`,`add_userid`,`add_username`,`addtime`,`edit_userid`,`edit_username`,`edittime`) values (1,NULL,10092998,1,'变压器',NULL,'15','40','220kV',NULL,'YNyn0d11','SFSZ10-150000/220','广州维奥伊林变压器有限公司','/','/','/','2006-10','005015','2,5','A1-6000（F型）抗干扰介质损耗测量 单臂电桥','2019年03月11日','1','合格','备注',NULL,NULL,NULL,NULL,NULL,NULL),(2,NULL,10092910,1,'变压器',NULL,'15','40','220kV',NULL,'YNyn0d11','SFSZ10-150000/220','广州维奥伊林变压器有限公司','/','/','/','2006-10','005015','2,5','A1-6000（F型）抗干扰介质损耗测量 单臂电桥','2019年03月11日','1','合格','备注',NULL,NULL,NULL,NULL,NULL,NULL);
